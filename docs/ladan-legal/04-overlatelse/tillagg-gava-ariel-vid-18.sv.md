# Tillägg — gåva till Ariel vid 18 års ålder

**UTKAST — G1 innan undertecknande**

Detta tillägg hör ihop med [`gavobrev-fastighet.sv.md`](gavobrev-fastighet.sv.md) och ska undertecknas **samma dag** som huvudgåvobrevet.
...
## 3. Förpliktelse för vuxna syskon (nuvarande ägare)
...
- **ekonomi** (skatt, försäkring, underhåll) sköts av givaren enligt samma avtal **tills** hans bortgång eller **ny överenskommelse** mellan parterna.

---

## 5. Om givaren avlider före Ariels 18-årsdag

Givarens **förpliktelse** enligt §2 ska **fullgöras av dödsboet** i den mån fastigheten då ingår i boet, eller genom **testamente** som bekräftar samma fördelning. *(Jurist granskar vid G1 — ev. separat testamente rekommenderas.)*
...
Vid granskning: kontrollera att upplägget är **tillräckligt bindande**, om **förmyndarnämnd** ska höras, och om **testamente** bör komplettera §5.
